...
#Processing steps: Pre-calculates skips. For example, you can calculate the total number of shifts/skips using the two rules for the pattern(P) = TCGC. It makes a look up tables with shift values
